...
Current status: subscription `ME-MngEnvMCAP242401-taner-1` (`7ad80d1b-c23b-46cf-baa5-64c6d6bccbbe`) and existing resource group `Nikhil-FabricIQ` in East US are verified. The Frontier RM foundation, live web/API, managed-identity Azure OpenAI model, and authenticated Teams bot have been deployed with owner and expiry tags.

Live cockpit: `https://ca-frontier-rm-api-kqo7o4bgpiiay.greensea-544a6a70.eastus.azurecontainerapps.io`
...
- Production web/API image `frontier-rm-api:0.8.2`

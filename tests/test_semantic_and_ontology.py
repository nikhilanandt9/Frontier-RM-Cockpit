...
class SemanticAndOntologyTests(unittest.TestCase):
    ...
    def test_direct_lake_model_has_complete_source_tree(self):
        ...
        self.assertIn("<FABRIC_WORKSPACE_ID>", expression)
        self.assertIn("<FABRIC_LAKEHOUSE_ID>", expression)
        ...
        for path in TABLES.glob("*.tmdl"):
            ...
            self.assertIn("expressionSource: 'DirectLake - <FABRIC_LAKEHOUSE_NAME>'", content, path.name)

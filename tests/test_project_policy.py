...
class ProjectPolicyTests(unittest.TestCase):
    def test_azure_provisioning_is_locked(self):
        ...
        self.assertEqual(config["resourceGroup"], "Nikhil-FabricIQ")
        self.assertTrue(config["subscriptionConfirmationRequired"])
        self.assertTrue(config["azureWritesEnabled"])
        self.assertEqual(config["confirmedSubscription"]["id"], "7ad80d1b-c23b-46cf-baa5-64c6d6bccbbe")
        ...
        self.assertEqual(config["deployment"]["apiImage"], "frontier-rm-api:0.8.0")
        self.assertEqual(
            config["deployment"]["apiImageDigest"],
            "sha256:085fdd348c2195b1285a948c936687508bd1c3458cc7e7c30eae6799dbd7da36",
        )
        self.assertEqual(config["deployment"]["apiRevision"], "ca-frontier-rm-api-kqo7o4bgpiiay--0000010")
        ...
        self.assertEqual(fabric["workspaceName"], "Frontier-RM-EBC")
        self.assertEqual(fabric["lakehouseName"], "FrontierRMLakehouse")

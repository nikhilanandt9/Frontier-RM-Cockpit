...
class FoundryAgentTests(unittest.TestCase):
    ...
    def test_preview_reports_resolved_fabric_connection(self) -> None:
        connection_id = "/subscriptions/sub/resourceGroups/rg/providers/Microsoft.CognitiveServices/accounts/a/projects/p/connections/<FOUNDRY_FABRIC_CONNECTION_NAME>"
    ...
    def test_deploy_creates_only_customer_intelligence_version(self, project_type, credential_type) -> None:
        ...
        deployed, connection_id = deploy(DEFAULT_ENDPOINT, DEFAULT_MODEL, "<FOUNDRY_FABRIC_CONNECTION_NAME>")

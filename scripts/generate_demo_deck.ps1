...
try {
    ...
    Add-ScreenshotPlaceholder $slide 'MICROSOFT FABRIC' 'Insert the <FABRIC_WORKSPACE_NAME> workspace or Lakehouse / medallion screenshot.' 54 160 852 314 'Suggested callout: 20 fictional clients · Bronze / Silver / Gold · schema-enabled Lakehouse'
    Add-Footer $slide 7

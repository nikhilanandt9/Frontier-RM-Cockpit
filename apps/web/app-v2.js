...
function renderOperations() {
  ...
  const services = [['Web cockpit', 'Healthy'], ['Azure OpenAI · gpt-4.1-mini', 'Live'], ['Fabric capacity · F4', 'Active'], ['<FABRIC_LAKEHOUSE_NAME>', 'Connected'], ['Teams bot', 'Healthy'], ['Deterministic fallback', 'Ready']];
